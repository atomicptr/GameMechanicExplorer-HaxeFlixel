...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Christopher Kaster", "gme", "de.kasoki.gme.walkingandjumping.withacceleration", "1.0.0");
		...
		flash.Lib.create (function () {
			...
			"Walking and Jumping - With Acceleration",
			null
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Walking and Jumping - With Acceleration", null, { width: 0, height: 0 });
