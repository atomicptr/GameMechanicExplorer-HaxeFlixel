...
{
HX_STACK_FRAME("haxe.zip.Compress","new",0x4ddc50a9,"haxe.zip.Compress.new","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",29,0x9f8c8027)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.zip.Compress","setFlushMode",0x35ab82dc,"haxe.zip.Compress.setFlushMode","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",37,0x9f8c8027)
		HX_STACK_THIS(this)
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(38)
