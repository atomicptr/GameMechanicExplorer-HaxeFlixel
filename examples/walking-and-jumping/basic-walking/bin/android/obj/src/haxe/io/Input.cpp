...
int Input_obj::readByte( ){
	HX_STACK_FRAME("haxe.io.Input","readByte",0x4de8a3c2,"haxe.io.Input.readByte","B:\\Programs\\Haxe\\haxe\\std/haxe/io/Input.hx",37,0xc2cee309)
	HX_STACK_THIS(this)
	HX_STACK_LINE(39)
...
{
		HX_STACK_FRAME("haxe.io.Input","close",0xfc421af4,"haxe.io.Input.close","B:\\Programs\\Haxe\\haxe\\std/haxe/io/Input.hx",67,0xc2cee309)
		HX_STACK_THIS(this)
	}
return null();
}
...
::String Input_obj::readLine( ){
	HX_STACK_FRAME("haxe.io.Input","readLine",0x54789cae,"haxe.io.Input.readLine","B:\\Programs\\Haxe\\haxe\\std/haxe/io/Input.hx",127,0xc2cee309)
	HX_STACK_THIS(this)
	HX_STACK_LINE(128)
