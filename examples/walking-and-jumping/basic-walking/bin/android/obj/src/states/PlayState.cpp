...
{
		HX_STACK_FRAME("states.PlayState","create",0x0cd56899,"states.PlayState.create","states/PlayState.hx",24,0x36e487ae)
		HX_STACK_THIS(this)
		HX_STACK_LINE(25)
		this->super::create();
		HX_STACK_LINE(27)
...
{
		HX_STACK_FRAME("states.PlayState","destroy",0x410194bd,"states.PlayState.destroy","states/PlayState.hx",62,0x36e487ae)
		HX_STACK_THIS(this)
		HX_STACK_LINE(62)
		this->super::destroy();
	}
...
{
		HX_STACK_FRAME("states.PlayState","update",0x17cb87a6,"states.PlayState.update","states/PlayState.hx",66,0x36e487ae)
		HX_STACK_THIS(this)
		HX_STACK_LINE(67)
		this->super::update();
		HX_STACK_LINE(69)
		if ((::flixel::FlxG_obj::keys->checkKeyStatus(Array_obj< ::String >::__new().Add(HX_CSTRING("LEFT")),(int)1))){
			HX_STACK_LINE(71)
			this->player->velocity->set_x(-(this->MAX_SPEED));
		}
		else{
			HX_STACK_LINE(72)
			if ((::flixel::FlxG_obj::keys->checkKeyStatus(Array_obj< ::String >::__new().Add(HX_CSTRING("RIGHT")),(int)1))){
				...
				HX_STACK_LINE(77)
				this->player->velocity->set_x((int)0);
			}
		}
		HX_STACK_LINE(81)
