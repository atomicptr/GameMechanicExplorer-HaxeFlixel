...
::Class Type_obj::getClass( Dynamic o){
	HX_STACK_FRAME("Type","getClass",0xc4e49bd6,"Type.getClass","B:\\Programs\\Haxe\\haxe\\std/cpp/_std/Type.hx",35,0x3d98af3a)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(36)
...
::Class Type_obj::getSuperClass( ::Class c){
	HX_STACK_FRAME("Type","getSuperClass",0xd9ffa85f,"Type.getSuperClass","B:\\Programs\\Haxe\\haxe\\std/cpp/_std/Type.hx",53,0x3d98af3a)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(53)
	return c->GetSuper();
}
...
::String Type_obj::getClassName( ::Class c){
	HX_STACK_FRAME("Type","getClassName",0x8e66dd41,"Type.getClassName","B:\\Programs\\Haxe\\haxe\\std/cpp/_std/Type.hx",56,0x3d98af3a)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(57)
	if (((c == null()))){
		HX_STACK_LINE(58)
...
::String Type_obj::getEnumName( ::Enum e){
	HX_STACK_FRAME("Type","getEnumName",0x9b42910e,"Type.getEnumName","B:\\Programs\\Haxe\\haxe\\std/cpp/_std/Type.hx",63,0x3d98af3a)
	HX_STACK_ARG(e,"e")
	HX_STACK_LINE(63)
	return e->__ToString();
}
...
::Class Type_obj::resolveClass( ::String name){
	HX_STACK_FRAME("Type","resolveClass",0x23b06bc0,"Type.resolveClass","B:\\Programs\\Haxe\\haxe\\std/cpp/_std/Type.hx",66,0x3d98af3a)
...
::Enum Type_obj::resolveEnum( ::String name){
	HX_STACK_FRAME("Type","resolveEnum",0x26394079,"Type.resolveEnum","B:\\Programs\\Haxe\\haxe\\std/cpp/_std/Type.hx",73,0x3d98af3a)
	HX_STACK_ARG(name,"name")
	HX_STACK_LINE(74)
	::Class result = ::Class_obj::Resolve(name);		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(75)
...
Dynamic Type_obj::createInstance( ::Class cl,Dynamic args){
	HX_STACK_FRAME("Type","createInstance",0xab84f9c5,"Type.createInstance","B:\\Programs\\Haxe\\haxe\\std/cpp/_std/Type.hx",80,0x3d98af3a)
	HX_STACK_ARG(cl,"cl")
...
Dynamic Type_obj::createEmptyInstance( ::Class cl){
	HX_STACK_FRAME("Type","createEmptyInstance",0xcb752312,"Type.createEmptyInstance","B:\\Programs\\Haxe\\haxe\\std/cpp/_std/Type.hx",87,0x3d98af3a)
	HX_STACK_ARG(cl,"cl")
	HX_STACK_LINE(87)
...
Dynamic Type_obj::createEnum( ::Enum e,::String constr,Dynamic params){
	HX_STACK_FRAME("Type","createEnum",0xd8d56d31,"Type.createEnum","B:\\Programs\\Haxe\\haxe\\std/cpp/_std/Type.hx",91,0x3d98af3a)
	HX_STACK_ARG(e,"e")
...
Dynamic Type_obj::createEnumIndex( ::Enum e,int index,Dynamic params){
	HX_STACK_FRAME("Type","createEnumIndex",0xd21e2c21,"Type.createEnumIndex","B:\\Programs\\Haxe\\haxe\\std/cpp/_std/Type.hx",94,0x3d98af3a)
	HX_STACK_ARG(e,"e")
...
Array< ::String > Type_obj::getInstanceFields( ::Class c){
	HX_STACK_FRAME("Type","getInstanceFields",0xe970f890,"Type.getInstanceFields","B:\\Programs\\Haxe\\haxe\\std/cpp/_std/Type.hx",101,0x3d98af3a)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(101)
...
Array< ::String > Type_obj::getClassFields( ::Class c){
	HX_STACK_FRAME("Type","getClassFields",0x7edf22ef,"Type.getClassFields","B:\\Programs\\Haxe\\haxe\\std/cpp/_std/Type.hx",105,0x3d98af3a)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(105)
...
Array< ::String > Type_obj::getEnumConstructs( ::Enum e){
	HX_STACK_FRAME("Type","getEnumConstructs",0x7f46cf7f,"Type.getEnumConstructs","B:\\Programs\\Haxe\\haxe\\std/cpp/_std/Type.hx",109,0x3d98af3a)
	HX_STACK_ARG(e,"e")
	HX_STACK_LINE(109)
...
::ValueType Type_obj::_typeof( Dynamic v){
	HX_STACK_FRAME("Type","typeof",0xd6c51d65,"Type.typeof","B:\\Programs\\Haxe\\haxe\\std/cpp/_std/Type.hx",112,0x3d98af3a)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(113)
	if (((v == null()))){
		HX_STACK_LINE(113)
