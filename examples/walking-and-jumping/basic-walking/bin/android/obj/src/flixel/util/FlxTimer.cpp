...
{
		HX_STACK_FRAME("flixel.util.FlxTimer","destroy",0x3b34c9f9,"flixel.util.FlxTimer.destroy","flixel/util/FlxTimer.hx",92,0x0a681e11)
		HX_STACK_THIS(this)
		HX_STACK_LINE(92)
		this->complete = null();
	}
...
{
		HX_STACK_FRAME("flixel.util.FlxTimer","update",0x0e95cdea,"flixel.util.FlxTimer.update","flixel/util/FlxTimer.hx",159,0x0a681e11)
		HX_STACK_THIS(this)
		HX_STACK_LINE(160)
