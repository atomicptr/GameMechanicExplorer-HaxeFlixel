...
{
HX_STACK_FRAME("flixel.system.frontEnds.PluginFrontEnd","new",0x6ca9c2b1,"flixel.system.frontEnds.PluginFrontEnd.new","flixel/system/frontEnds/PluginFrontEnd.hx",117,0xbff70e9e)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(118)
	...
	this->list = _g;
	HX_STACK_LINE(120)
	::flixel::plugin::PathManager _g1 = ::flixel::plugin::PathManager_obj::__new();		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(120)
	::flixel::plugin::PathManager _g2 = ::flixel::util::FlxPath_obj::manager = _g1;		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(120)
	this->add_flixel_plugin_PathManager(_g2);
	HX_STACK_LINE(121)
	::flixel::plugin::TimerManager _g3 = ::flixel::plugin::TimerManager_obj::__new();		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(121)
	::flixel::plugin::TimerManager _g4 = ::flixel::util::FlxTimer_obj::manager = _g3;		HX_STACK_VAR(_g4,"_g4");
	HX_STACK_LINE(121)
	this->add_flixel_plugin_TimerManager(_g4);
	HX_STACK_LINE(122)
	::flixel::plugin::TweenManager _g5 = ::flixel::plugin::TweenManager_obj::__new();		HX_STACK_VAR(_g5,"_g5");
	HX_STACK_LINE(122)
	::flixel::plugin::TweenManager _g6 = ::flixel::tweens::FlxTween_obj::manager = _g5;		HX_STACK_VAR(_g6,"_g6");
	HX_STACK_LINE(122)
	this->add_flixel_plugin_TweenManager(_g6);
}
;
	return null();
}
...
{
		HX_STACK_FRAME("flixel.system.frontEnds.PluginFrontEnd","update",0xe8fd1c58,"flixel.system.frontEnds.PluginFrontEnd.update","flixel/system/frontEnds/PluginFrontEnd.hx",130,0xbff70e9e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(130)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(130)
...
{
		HX_STACK_FRAME("flixel.system.frontEnds.PluginFrontEnd","draw",0xa14e4093,"flixel.system.frontEnds.PluginFrontEnd.draw","flixel/system/frontEnds/PluginFrontEnd.hx",144,0xbff70e9e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(144)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(144)
...
{
		HX_STACK_FRAME("flixel.system.frontEnds.PluginFrontEnd","onStateSwitch",0xb3451597,"flixel.system.frontEnds.PluginFrontEnd.onStateSwitch","flixel/system/frontEnds/PluginFrontEnd.hx",158,0xbff70e9e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(158)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(158)
...
{
		HX_STACK_FRAME("flixel.system.frontEnds.PluginFrontEnd","onResize",0x67ed5882,"flixel.system.frontEnds.PluginFrontEnd.onResize","flixel/system/frontEnds/PluginFrontEnd.hx",174,0xbff70e9e)
		HX_STACK_THIS(this)
