...
{
		HX_STACK_FRAME("flixel.plugin.PathManager","destroy",0xa78a694b,"flixel.plugin.PathManager.destroy","flixel/plugin/PathManager.hx",28,0xf3716a7f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(29)
...
{
		HX_STACK_FRAME("flixel.plugin.PathManager","update",0x90cafed8,"flixel.plugin.PathManager.update","flixel/plugin/PathManager.hx",37,0xf3716a7f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(37)
...
{
		HX_STACK_FRAME("flixel.plugin.PathManager","add",0xc86371f2,"flixel.plugin.PathManager.add","flixel/plugin/PathManager.hx",74,0xf3716a7f)
		HX_STACK_THIS(this)
		HX_STACK_ARG(Path,"Path")
		HX_STACK_LINE(75)
		int _g = ::flixel::util::FlxArrayUtil_obj::indexOf_flixel_util_FlxPath(this->_paths,Path,null());		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(75)
		if (((_g < (int)0))){
			HX_STACK_LINE(77)
...
bool ReturnInPool = __o_ReturnInPool.Default(true);
	HX_STACK_FRAME("flixel.plugin.PathManager","remove",0x0e4e1513,"flixel.plugin.PathManager.remove","flixel/plugin/PathManager.hx",89,0xf3716a7f)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Path,"Path")
	HX_STACK_ARG(ReturnInPool,"ReturnInPool")
{
		...
		HX_STACK_LINE(89)
		int index = ::flixel::util::FlxArrayUtil_obj::indexOf_fastSplice_T(array,Path,null());		HX_STACK_VAR(index,"index");
		HX_STACK_LINE(89)
		if (((index != (int)-1))){
			HX_STACK_LINE(89)
...
{
		HX_STACK_FRAME("flixel.plugin.PathManager","clear",0x69b1479e,"flixel.plugin.PathManager.clear","flixel/plugin/PathManager.hx",97,0xf3716a7f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(97)
		::flixel::util::FlxArrayUtil_obj::clearArray_flixel_util_FlxPath(this->_paths,null());
	}
...
{
		HX_STACK_FRAME("flixel.plugin.PathManager","onStateSwitch",0x71108317,"flixel.plugin.PathManager.onStateSwitch","flixel/plugin/PathManager.hx",102,0xf3716a7f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(102)
		::flixel::util::FlxArrayUtil_obj::clearArray_flixel_util_FlxPath(this->_paths,null());
	}
