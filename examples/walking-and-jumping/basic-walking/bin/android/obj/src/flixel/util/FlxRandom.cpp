		...
		if (((Min == Max))){
			...
			if (((Excludes == null()))){
				...
				while((true)){
					...
					HX_STACK_LINE(174)
					int _g10 = ::flixel::util::FlxArrayUtil_obj::indexOf_Int(Excludes,::flixel::util::FlxRandom_obj::_intHelper,null());		HX_STACK_VAR(_g10,"_g10");
					HX_STACK_LINE(170)
					if ((!(((_g10 >= (int)0))))){
						HX_STACK_LINE(170)
						break;
		...
		if (((Min == Max))){
			...
			if (((Excludes == null()))){
				...
				while((true)){
					...
					HX_STACK_LINE(216)
					int _g8 = ::flixel::util::FlxArrayUtil_obj::indexOf_Float(Excludes,::flixel::util::FlxRandom_obj::_floatHelper,null());		HX_STACK_VAR(_g8,"_g8");
					HX_STACK_LINE(212)
					if ((!(((_g8 >= (int)0))))){
						HX_STACK_LINE(212)
						break;
