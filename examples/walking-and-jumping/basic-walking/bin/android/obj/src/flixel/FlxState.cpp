...
{
		HX_STACK_FRAME("flixel.FlxState","create",0x1148b519,"flixel.FlxState.create","flixel/FlxState.hx",49,0xdf96844c)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("flixel.FlxState","draw",0x1022c8e1,"flixel.FlxState.draw","flixel/FlxState.hx",52,0xdf96844c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(53)
...
{
		HX_STACK_FRAME("flixel.FlxState","openSubState",0x3d5ea838,"flixel.FlxState.openSubState","flixel/FlxState.hx",65,0xdf96844c)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.FlxState","closeSubState",0x519577cc,"flixel.FlxState.closeSubState","flixel/FlxState.hx",74,0xdf96844c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(75)
		this->_requestSubStateReset = true;
		HX_STACK_LINE(76)
...
{
		HX_STACK_FRAME("flixel.FlxState","resetSubState",0x772d18e3,"flixel.FlxState.resetSubState","flixel/FlxState.hx",83,0xdf96844c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(85)
		if (((this->subState != null()))){
			HX_STACK_LINE(87)
...
{
		HX_STACK_FRAME("flixel.FlxState","destroy",0x2171383d,"flixel.FlxState.destroy","flixel/FlxState.hx",118,0xdf96844c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(119)
		if (((this->subState != null()))){
			HX_STACK_LINE(121)
...
{
		HX_STACK_FRAME("flixel.FlxState","onFocusLost",0x8c2b4d80,"flixel.FlxState.onFocusLost","flixel/FlxState.hx",131,0xdf96844c)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("flixel.FlxState","onFocus",0x97b2097c,"flixel.FlxState.onFocus","flixel/FlxState.hx",137,0xdf96844c)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("flixel.FlxState","onResize",0x38e71fd0,"flixel.FlxState.onResize","flixel/FlxState.hx",145,0xdf96844c)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.FlxState","tryUpdate",0xc75023a7,"flixel.FlxState.tryUpdate","flixel/FlxState.hx",149,0xdf96844c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(150)
...
int FlxState_obj::get_bgColor( ){
	HX_STACK_FRAME("flixel.FlxState","get_bgColor",0xc8234a38,"flixel.FlxState.get_bgColor","flixel/FlxState.hx",168,0xdf96844c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(168)
...
int FlxState_obj::set_bgColor( int Value){
	HX_STACK_FRAME("flixel.FlxState","set_bgColor",0xd2905144,"flixel.FlxState.set_bgColor","flixel/FlxState.hx",173,0xdf96844c)
	HX_STACK_THIS(this)
