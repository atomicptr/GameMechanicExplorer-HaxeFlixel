...
int FlxAngle_obj::angleLimit( int angle,int min,int max){
	HX_STACK_FRAME("flixel.util.FlxAngle","angleLimit",0x2a40d57b,"flixel.util.FlxAngle.angleLimit","flixel/util/FlxAngle.hx",236,0x34a716c3)
	HX_STACK_ARG(angle,"angle")
...
Float FlxAngle_obj::asDegrees( Float radians){
	HX_STACK_FRAME("flixel.util.FlxAngle","asDegrees",0x19409522,"flixel.util.FlxAngle.asDegrees","flixel/util/FlxAngle.hx",260,0x34a716c3)
...
Float FlxAngle_obj::asRadians( Float degrees){
	HX_STACK_FRAME("flixel.util.FlxAngle","asRadians",0x05d5f7ed,"flixel.util.FlxAngle.asRadians","flixel/util/FlxAngle.hx",272,0x34a716c3)
...
bool AsDegrees = __o_AsDegrees.Default(false);
	HX_STACK_FRAME("flixel.util.FlxAngle","angleBetween",0xb3fd5808,"flixel.util.FlxAngle.angleBetween","flixel/util/FlxAngle.hx",285,0x34a716c3)
...
bool AsDegrees = __o_AsDegrees.Default(false);
	HX_STACK_FRAME("flixel.util.FlxAngle","angleBetweenPoint",0xab3baf28,"flixel.util.FlxAngle.angleBetweenPoint","flixel/util/FlxAngle.hx",305,0x34a716c3)
...
bool AsDegrees = __o_AsDegrees.Default(false);
	HX_STACK_FRAME("flixel.util.FlxAngle","angleBetweenMouse",0xf11110fd,"flixel.util.FlxAngle.angleBetweenMouse","flixel/util/FlxAngle.hx",325,0x34a716c3)
...
bool AsDegrees = __o_AsDegrees.Default(false);
	HX_STACK_FRAME("flixel.util.FlxAngle","angleBetweenTouch",0xf8df1297,"flixel.util.FlxAngle.angleBetweenTouch","flixel/util/FlxAngle.hx",353,0x34a716c3)
	HX_STACK_ARG(Object,"Object")
...
::flixel::util::FlxPoint FlxAngle_obj::getCartesianCoords( Float Radius,Float Angle,::flixel::util::FlxPoint point){
	HX_STACK_FRAME("flixel.util.FlxAngle","getCartesianCoords",0xcba23863,"flixel.util.FlxAngle.getCartesianCoords","flixel/util/FlxAngle.hx",376,0x34a716c3)
...
::flixel::util::FlxPoint FlxAngle_obj::getPolarCoords( Float X,Float Y,::flixel::util::FlxPoint point){
	HX_STACK_FRAME("flixel.util.FlxAngle","getPolarCoords",0xef5b8a19,"flixel.util.FlxAngle.getPolarCoords","flixel/util/FlxAngle.hx",397,0x34a716c3)
	HX_STACK_ARG(X,"X")
	HX_STACK_ARG(Y,"Y")
	HX_STACK_ARG(point,"point")
	HX_STACK_LINE(398)
...
Float FlxAngle_obj::get_TO_DEG( ){
	HX_STACK_FRAME("flixel.util.FlxAngle","get_TO_DEG",0xf3e2f47e,"flixel.util.FlxAngle.get_TO_DEG","flixel/util/FlxAngle.hx",411,0x34a716c3)
	HX_STACK_LINE(411)
...
Float FlxAngle_obj::get_TO_RAD( ){
	HX_STACK_FRAME("flixel.util.FlxAngle","get_TO_RAD",0xf3ed908d,"flixel.util.FlxAngle.get_TO_RAD","flixel/util/FlxAngle.hx",416,0x34a716c3)
	HX_STACK_LINE(416)
