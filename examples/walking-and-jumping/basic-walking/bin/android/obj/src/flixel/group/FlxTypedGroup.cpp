...
Dynamic FlxTypedGroup_obj::add( Dynamic Object){
	...
	HX_STACK_LINE(133)
	int _g = ::flixel::util::FlxArrayUtil_obj::indexOf_flixel_group_FlxTypedGroup_T(this->members,Object,null());		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(133)
	if (((_g >= (int)0))){
		HX_STACK_LINE(135)
		return Object;
	...
	HX_STACK_ARG(Splice,"Splice")
{
		...
		HX_STACK_LINE(260)
		int index = ::flixel::util::FlxArrayUtil_obj::indexOf_flixel_group_FlxTypedGroup_T(this->members,Object,null());		HX_STACK_VAR(index,"index");
		HX_STACK_LINE(262)
		if (((index < (int)0))){
			HX_STACK_LINE(263)
			return null();
...
Dynamic FlxTypedGroup_obj::replace( Dynamic OldObject,Dynamic NewObject){
	...
	HX_STACK_LINE(283)
	int index = ::flixel::util::FlxArrayUtil_obj::indexOf_flixel_group_FlxTypedGroup_T(this->members,OldObject,null());		HX_STACK_VAR(index,"index");
	HX_STACK_LINE(285)
	if (((index < (int)0))){
		HX_STACK_LINE(286)
		return null();
