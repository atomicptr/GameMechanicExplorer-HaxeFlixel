...
{
HX_STACK_FRAME("flixel.system.debug.TrackerProfile","new",0xa683e46b,"flixel.system.debug.TrackerProfile.new","flixel/system/debug/Tracker.hx",237,0x59950a0f)
HX_STACK_THIS(this)
...
::String TrackerProfile_obj::toString( ){
	HX_STACK_FRAME("flixel.system.debug.TrackerProfile","toString",0xad6334c1,"flixel.system.debug.TrackerProfile.toString","flixel/system/debug/Tracker.hx",244,0x59950a0f)
	HX_STACK_THIS(this)
	HX_STACK_LINE(246)
