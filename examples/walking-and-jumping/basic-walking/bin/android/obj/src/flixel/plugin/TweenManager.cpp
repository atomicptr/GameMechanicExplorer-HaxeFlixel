...
bool Start = __o_Start.Default(false);
	HX_STACK_FRAME("flixel.plugin.TweenManager","add_flixel_tweens_motion_QuadPath",0x2aa0f560,"flixel.plugin.TweenManager.add_flixel_tweens_motion_QuadPath","flixel/plugin/TweenManager.hx",63,0x8f088e93)
	HX_STACK_THIS(this)
...
bool Start = __o_Start.Default(false);
	HX_STACK_FRAME("flixel.plugin.TweenManager","add_flixel_tweens_motion_LinearPath",0xb741727e,"flixel.plugin.TweenManager.add_flixel_tweens_motion_LinearPath","flixel/plugin/TweenManager.hx",63,0x8f088e93)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Tween,"Tween")
	HX_STACK_ARG(Start,"Start")
{
...
bool Start = __o_Start.Default(false);
	HX_STACK_FRAME("flixel.plugin.TweenManager","add_flixel_tweens_motion_CircularMotion",0xb3d7a449,"flixel.plugin.TweenManager.add_flixel_tweens_motion_CircularMotion","flixel/plugin/TweenManager.hx",63,0x8f088e93)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Tween,"Tween")
	HX_STACK_ARG(Start,"Start")
{
...
bool Start = __o_Start.Default(false);
	HX_STACK_FRAME("flixel.plugin.TweenManager","add_flixel_tweens_motion_CubicMotion",0x8d10bc4c,"flixel.plugin.TweenManager.add_flixel_tweens_motion_CubicMotion","flixel/plugin/TweenManager.hx",63,0x8f088e93)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Tween,"Tween")
	HX_STACK_ARG(Start,"Start")
{
...
bool Start = __o_Start.Default(false);
	HX_STACK_FRAME("flixel.plugin.TweenManager","add_flixel_tweens_motion_QuadMotion",0xa95c3ab1,"flixel.plugin.TweenManager.add_flixel_tweens_motion_QuadMotion","flixel/plugin/TweenManager.hx",63,0x8f088e93)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Tween,"Tween")
	HX_STACK_ARG(Start,"Start")
{
...
bool Start = __o_Start.Default(false);
	HX_STACK_FRAME("flixel.plugin.TweenManager","add_flixel_tweens_motion_LinearMotion",0xfcecbb4f,"flixel.plugin.TweenManager.add_flixel_tweens_motion_LinearMotion","flixel/plugin/TweenManager.hx",63,0x8f088e93)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Tween,"Tween")
	HX_STACK_ARG(Start,"Start")
{
...
bool Start = __o_Start.Default(false);
	HX_STACK_FRAME("flixel.plugin.TweenManager","add_flixel_tweens_misc_ColorTween",0x5d4514a6,"flixel.plugin.TweenManager.add_flixel_tweens_misc_ColorTween","flixel/plugin/TweenManager.hx",63,0x8f088e93)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Tween,"Tween")
	HX_STACK_ARG(Start,"Start")
{
...
bool Start = __o_Start.Default(false);
	HX_STACK_FRAME("flixel.plugin.TweenManager","add_flixel_tweens_misc_AngleTween",0x3c5e6c36,"flixel.plugin.TweenManager.add_flixel_tweens_misc_AngleTween","flixel/plugin/TweenManager.hx",63,0x8f088e93)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Tween,"Tween")
	HX_STACK_ARG(Start,"Start")
{
...
bool Start = __o_Start.Default(false);
	HX_STACK_FRAME("flixel.plugin.TweenManager","add_flixel_tweens_misc_NumTween",0xfb008d63,"flixel.plugin.TweenManager.add_flixel_tweens_misc_NumTween","flixel/plugin/TweenManager.hx",63,0x8f088e93)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Tween,"Tween")
	HX_STACK_ARG(Start,"Start")
{
...
bool Start = __o_Start.Default(false);
	HX_STACK_FRAME("flixel.plugin.TweenManager","add_flixel_tweens_misc_VarTween",0x84afa522,"flixel.plugin.TweenManager.add_flixel_tweens_misc_VarTween","flixel/plugin/TweenManager.hx",63,0x8f088e93)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Tween,"Tween")
	HX_STACK_ARG(Start,"Start")
{
...
::flixel::tweens::FlxTween TweenManager_obj::remove( ::flixel::tweens::FlxTween Tween){
	HX_STACK_FRAME("flixel.plugin.TweenManager","remove",0x68b2eb67,"flixel.plugin.TweenManager.remove","flixel/plugin/TweenManager.hx",88,0x8f088e93)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Tween,"Tween")
	HX_STACK_LINE(89)
	if (((Tween == null()))){
	...
	HX_STACK_LINE(97)
	{
		...
		HX_STACK_LINE(97)
		int index = ::flixel::util::FlxArrayUtil_obj::indexOf_fastSplice_T(array,Tween,null());		HX_STACK_VAR(index,"index");
		HX_STACK_LINE(97)
		if (((index != (int)-1))){
			HX_STACK_LINE(97)
...
{
		HX_STACK_FRAME("flixel.plugin.TweenManager","clear",0xf87297ca,"flixel.plugin.TweenManager.clear","flixel/plugin/TweenManager.hx",107,0x8f088e93)
		HX_STACK_THIS(this)
		HX_STACK_LINE(107)
		while((true)){
			HX_STACK_LINE(107)
...
{
		HX_STACK_FRAME("flixel.plugin.TweenManager","onStateSwitch",0xdb1fdf43,"flixel.plugin.TweenManager.onStateSwitch","flixel/plugin/TweenManager.hx",115,0x8f088e93)
		HX_STACK_THIS(this)
		HX_STACK_LINE(115)
		this->clear();
	}
