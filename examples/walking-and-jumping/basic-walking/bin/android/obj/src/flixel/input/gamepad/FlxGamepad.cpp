...
bool FlxGamepad_obj::justPressed( int ButtonID){
	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","justPressed",0x4d91e6ba,"flixel.input.gamepad.FlxGamepad.justPressed","flixel/input/gamepad/FlxGamepad.hx",282,0xdb78a809)
	HX_STACK_THIS(this)
	HX_STACK_ARG(ButtonID,"ButtonID")
	HX_STACK_LINE(283)
	if (((this->buttons->__get(ButtonID).StaticCast< ::flixel::input::gamepad::FlxGamepadButton >() != null()))){
...
bool FlxGamepad_obj::justReleased( int ButtonID){
	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","justReleased",0x98ee09a5,"flixel.input.gamepad.FlxGamepad.justReleased","flixel/input/gamepad/FlxGamepad.hx",298,0xdb78a809)
	HX_STACK_THIS(this)
	HX_STACK_ARG(ButtonID,"ButtonID")
	HX_STACK_LINE(299)
	if (((this->buttons->__get(ButtonID).StaticCast< ::flixel::input::gamepad::FlxGamepadButton >() != null()))){
...
int FlxGamepad_obj::firstPressedButtonID( ){
	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","firstPressedButtonID",0xdedbb35b,"flixel.input.gamepad.FlxGamepad.firstPressedButtonID","flixel/input/gamepad/FlxGamepad.hx",312,0xdb78a809)
	HX_STACK_THIS(this)
	HX_STACK_LINE(313)
	{
		HX_STACK_LINE(313)
...
int FlxGamepad_obj::firstJustPressedButtonID( ){
	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","firstJustPressedButtonID",0x2f24588f,"flixel.input.gamepad.FlxGamepad.firstJustPressedButtonID","flixel/input/gamepad/FlxGamepad.hx",329,0xdb78a809)
	HX_STACK_THIS(this)
	HX_STACK_LINE(330)
	{
		HX_STACK_LINE(330)
...
int FlxGamepad_obj::firstJustReleasedButtonID( ){
	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","firstJustReleasedButtonID",0x67d646aa,"flixel.input.gamepad.FlxGamepad.firstJustReleasedButtonID","flixel/input/gamepad/FlxGamepad.hx",346,0xdb78a809)
	HX_STACK_THIS(this)
	HX_STACK_LINE(347)
	{
		HX_STACK_LINE(347)
...
Float FlxGamepad_obj::getAxis( int AxisID){
	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","getAxis",0x2a07633b,"flixel.input.gamepad.FlxGamepad.getAxis","flixel/input/gamepad/FlxGamepad.hx",364,0xdb78a809)
	HX_STACK_THIS(this)
...
Float FlxGamepad_obj::getXAxis( int AxisID){
	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","getXAxis",0xb657655f,"flixel.input.gamepad.FlxGamepad.getXAxis","flixel/input/gamepad/FlxGamepad.hx",372,0xdb78a809)
	HX_STACK_THIS(this)
	HX_STACK_ARG(AxisID,"AxisID")
	HX_STACK_LINE(372)
	return this->getAxisValue(AxisID);
...
Float FlxGamepad_obj::getYAxis( int AxisID){
	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","getYAxis",0x49bdf9e0,"flixel.input.gamepad.FlxGamepad.getYAxis","flixel/input/gamepad/FlxGamepad.hx",380,0xdb78a809)
	HX_STACK_THIS(this)
	HX_STACK_ARG(AxisID,"AxisID")
	HX_STACK_LINE(381)
...
bool FlxGamepad_obj::anyButton( ){
	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","anyButton",0xd989e1e2,"flixel.input.gamepad.FlxGamepad.anyButton","flixel/input/gamepad/FlxGamepad.hx",400,0xdb78a809)
	HX_STACK_THIS(this)
	HX_STACK_LINE(401)
	{
		HX_STACK_LINE(401)
...
bool FlxGamepad_obj::anyInput( ){
	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","anyInput",0x4fe8921a,"flixel.input.gamepad.FlxGamepad.anyInput","flixel/input/gamepad/FlxGamepad.hx",416,0xdb78a809)
	HX_STACK_THIS(this)
	HX_STACK_LINE(417)
	if ((this->anyButton())){
		HX_STACK_LINE(418)
...
Float FlxGamepad_obj::getAxisValue( int AxisID){
	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","getAxisValue",0xcd45f636,"flixel.input.gamepad.FlxGamepad.getAxisValue","flixel/input/gamepad/FlxGamepad.hx",446,0xdb78a809)
	HX_STACK_THIS(this)
	HX_STACK_ARG(AxisID,"AxisID")
	HX_STACK_LINE(447)
...
bool FlxGamepad_obj::get_dpadUp( ){
	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","get_dpadUp",0x080d2b0f,"flixel.input.gamepad.FlxGamepad.get_dpadUp","flixel/input/gamepad/FlxGamepad.hx",475,0xdb78a809)
	HX_STACK_THIS(this)
	HX_STACK_LINE(475)
...
bool FlxGamepad_obj::get_dpadDown( ){
	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","get_dpadDown",0xfabc5216,"flixel.input.gamepad.FlxGamepad.get_dpadDown","flixel/input/gamepad/FlxGamepad.hx",476,0xdb78a809)
	HX_STACK_THIS(this)
	HX_STACK_LINE(476)
	return (this->hat->y > (int)0);
}
...
bool FlxGamepad_obj::get_dpadLeft( ){
	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","get_dpadLeft",0xfffe61bb,"flixel.input.gamepad.FlxGamepad.get_dpadLeft","flixel/input/gamepad/FlxGamepad.hx",477,0xdb78a809)
	HX_STACK_THIS(this)
	HX_STACK_LINE(477)
...
bool FlxGamepad_obj::get_dpadRight( ){
	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","get_dpadRight",0x75a42fa8,"flixel.input.gamepad.FlxGamepad.get_dpadRight","flixel/input/gamepad/FlxGamepad.hx",478,0xdb78a809)
	HX_STACK_THIS(this)
	HX_STACK_LINE(478)
	return (this->hat->x > (int)0);
}
