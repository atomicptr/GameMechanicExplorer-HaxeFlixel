...
{
HX_STACK_FRAME("flixel.util.LabelValuePair","new",0x8e753503,"flixel.util.LabelValuePair.new","flixel/util/FlxStringUtil.hx",567,0x4e012e33)
HX_STACK_THIS(this)
{
}
;
...
::flixel::util::LabelValuePair LabelValuePair_obj::create( ::String label,Dynamic value){
	HX_STACK_FRAME("flixel.util.LabelValuePair","create",0x3da24a39,"flixel.util.LabelValuePair.create","flixel/util/FlxStringUtil.hx",550,0x4e012e33)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.util.LabelValuePair","put",0x8e76c772,"flixel.util.LabelValuePair.put","flixel/util/FlxStringUtil.hx",558,0x4e012e33)
		HX_STACK_THIS(this)
		HX_STACK_LINE(558)
...
{
		HX_STACK_FRAME("flixel.util.LabelValuePair","destroy",0xc37a1f1d,"flixel.util.LabelValuePair.destroy","flixel/util/FlxStringUtil.hx",562,0x4e012e33)
		HX_STACK_THIS(this)
		HX_STACK_LINE(563)
		this->label = null();
		HX_STACK_LINE(564)
...
::flixel::util::LabelValuePair LabelValuePair_obj::weak( ::String label,Dynamic value){
	HX_STACK_FRAME("flixel.util.LabelValuePair","weak",0x1e0c0675,"flixel.util.LabelValuePair.weak","flixel/util/FlxStringUtil.hx",543,0x4e012e33)
	HX_STACK_ARG(label,"label")
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(543)
