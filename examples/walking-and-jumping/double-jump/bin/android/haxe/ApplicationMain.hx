...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Christopher Kaster", "gme", "de.kasoki.gme.walkingandjumping.doublejump", "1.0.0");
		...
		flash.Lib.create (function () {
			...
			"Walking and Jumping - Double Jump",
			null
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Walking and Jumping - Double Jump", null, { width: 0, height: 0 });
