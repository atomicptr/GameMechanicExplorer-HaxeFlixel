...
class HXCPP_CLASS_ATTRIBUTES  FlxTypedSpriteGroup_obj : public ::flixel::FlxSprite_obj{
	...
	public:
		...
		virtual Void blendTransform( ::flixel::FlxSprite Sprite,::flash::display::BlendMode Blend);
		...
		virtual ::flash::display::BitmapData set_pixels( ::flash::display::BitmapData Value);
