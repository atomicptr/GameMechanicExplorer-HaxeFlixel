...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::flash::Lib_obj::setPackage(HX_CSTRING("Christopher Kaster"),HX_CSTRING("gme"),HX_CSTRING("de.kasoki.gme.walkingandjumping.doublejump"),HX_CSTRING("1.0.0"));
