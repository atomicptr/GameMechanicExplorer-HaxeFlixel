...
::String CallStack_obj::toString( Array< ::Dynamic > stack){
	HX_STACK_FRAME("haxe.CallStack","toString",0xd59be738,"haxe.CallStack.toString","/usr/local/lib/haxe/std/haxe/CallStack.hx",170,0x6022c9c0)
...
{
		HX_STACK_FRAME("haxe.CallStack","itemToString",0xc121696b,"haxe.CallStack.itemToString","/usr/local/lib/haxe/std/haxe/CallStack.hx",180,0x6022c9c0)
		HX_STACK_ARG(b,"b")
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(180)
