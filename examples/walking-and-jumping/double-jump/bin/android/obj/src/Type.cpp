...
::Class Type_obj::getSuperClass( ::Class c){
	HX_STACK_FRAME("Type","getSuperClass",0xd9ffa85f,"Type.getSuperClass","/usr/local/lib/haxe/std/cpp/_std/Type.hx",53,0xb5f2d6e2)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(53)
	return c->GetSuper();
}
...
::String Type_obj::getEnumName( ::Enum e){
	HX_STACK_FRAME("Type","getEnumName",0x9b42910e,"Type.getEnumName","/usr/local/lib/haxe/std/cpp/_std/Type.hx",63,0xb5f2d6e2)
	HX_STACK_ARG(e,"e")
	HX_STACK_LINE(63)
	return e->__ToString();
}
...
Dynamic Type_obj::createEmptyInstance( ::Class cl){
	HX_STACK_FRAME("Type","createEmptyInstance",0xcb752312,"Type.createEmptyInstance","/usr/local/lib/haxe/std/cpp/_std/Type.hx",87,0xb5f2d6e2)
	HX_STACK_ARG(cl,"cl")
	HX_STACK_LINE(87)
...
Dynamic Type_obj::createEnum( ::Enum e,::String constr,Dynamic params){
	HX_STACK_FRAME("Type","createEnum",0xd8d56d31,"Type.createEnum","/usr/local/lib/haxe/std/cpp/_std/Type.hx",91,0xb5f2d6e2)
	HX_STACK_ARG(e,"e")
...
Dynamic Type_obj::createEnumIndex( ::Enum e,int index,Dynamic params){
	HX_STACK_FRAME("Type","createEnumIndex",0xd21e2c21,"Type.createEnumIndex","/usr/local/lib/haxe/std/cpp/_std/Type.hx",94,0xb5f2d6e2)
	HX_STACK_ARG(e,"e")
...
Array< ::String > Type_obj::getInstanceFields( ::Class c){
	HX_STACK_FRAME("Type","getInstanceFields",0xe970f890,"Type.getInstanceFields","/usr/local/lib/haxe/std/cpp/_std/Type.hx",101,0xb5f2d6e2)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(101)
