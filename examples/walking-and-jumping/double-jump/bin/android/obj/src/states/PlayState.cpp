...
{
		HX_STACK_FRAME("states.PlayState","create",0x0cd56899,"states.PlayState.create","states/PlayState.hx",32,0x36e487ae)
		HX_STACK_THIS(this)
		HX_STACK_LINE(33)
		this->super::create();
		HX_STACK_LINE(35)
...
{
		HX_STACK_FRAME("states.PlayState","destroy",0x410194bd,"states.PlayState.destroy","states/PlayState.hx",101,0x36e487ae)
		HX_STACK_THIS(this)
		HX_STACK_LINE(101)
		this->super::destroy();
	}
...
{
		HX_STACK_FRAME("states.PlayState","update",0x17cb87a6,"states.PlayState.update","states/PlayState.hx",105,0x36e487ae)
		HX_STACK_THIS(this)
		HX_STACK_LINE(106)
