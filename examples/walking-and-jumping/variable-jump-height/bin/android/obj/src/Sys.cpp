...
{
		HX_STACK_FRAME("Sys","sleep",0xfe70aad6,"Sys.sleep","/usr/local/lib/haxe/std/cpp/_std/Sys.hx",65,0xd23c22f3)
...
{
		HX_STACK_FRAME("Sys","exit",0xed97463f,"Sys.exit","/usr/local/lib/haxe/std/cpp/_std/Sys.hx",108,0xd23c22f3)
