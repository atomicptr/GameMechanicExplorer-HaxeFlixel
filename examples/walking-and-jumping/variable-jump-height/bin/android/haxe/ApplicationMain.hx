...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Christopher Kaster", "gme", "de.kasoki.gme.walkingandjumping.variablejumpheight", "1.0.0");
		...
		flash.Lib.create (function () {
			...
			"Walking and Jumping - Variable Jump Height",
			null
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Walking and Jumping - Variable Jump Height", null, { width: 0, height: 0 });
