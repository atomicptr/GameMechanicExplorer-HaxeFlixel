...
Void PlayState_obj::create( ){
{
		...
		HX_STACK_LINE(40)
		this->ship->drag->set_x(this->DRAG);
		HX_STACK_LINE(41)
		this->ship->drag->set_y(this->DRAG);
		HX_STACK_LINE(43)
...
{
		HX_STACK_FRAME("states.PlayState","destroy",0x410194bd,"states.PlayState.destroy","states/PlayState.hx",50,0x36e487ae)
		HX_STACK_THIS(this)
		HX_STACK_LINE(50)
		this->super::destroy();
	}
