...
int Memory_obj::getByte( int addr){
	HX_STACK_FRAME("flash.Memory","getByte",0x0bca7d6f,"flash.Memory.getByte","flash/Memory.hx",139,0x29e6a1de)
...
Float Memory_obj::getDouble( int addr){
	HX_STACK_FRAME("flash.Memory","getDouble",0x7cd43138,"flash.Memory.getDouble","flash/Memory.hx",147,0x29e6a1de)
	HX_STACK_ARG(addr,"addr")
	HX_STACK_LINE(147)
...
Float Memory_obj::getFloat( int addr){
	HX_STACK_FRAME("flash.Memory","getFloat",0x8a620155,"flash.Memory.getFloat","flash/Memory.hx",155,0x29e6a1de)
	HX_STACK_ARG(addr,"addr")
	HX_STACK_LINE(155)
...
int Memory_obj::getI32( int addr){
	HX_STACK_FRAME("flash.Memory","getI32",0x9e7e84c1,"flash.Memory.getI32","flash/Memory.hx",163,0x29e6a1de)
	HX_STACK_ARG(addr,"addr")
	HX_STACK_LINE(163)
...
int Memory_obj::getUI16( int addr){
	HX_STACK_FRAME("flash.Memory","getUI16",0x1834e480,"flash.Memory.getUI16","flash/Memory.hx",171,0x29e6a1de)
	HX_STACK_ARG(addr,"addr")
	HX_STACK_LINE(171)
...
{
		HX_STACK_FRAME("flash.Memory","setByte",0xfecc0e7b,"flash.Memory.setByte","flash/Memory.hx",179,0x29e6a1de)
		HX_STACK_ARG(addr,"addr")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(179)
...
{
		HX_STACK_FRAME("flash.Memory","setDouble",0x60251d44,"flash.Memory.setDouble","flash/Memory.hx",187,0x29e6a1de)
		HX_STACK_ARG(addr,"addr")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(187)
...
{
		HX_STACK_FRAME("flash.Memory","setFloat",0x38bf5ac9,"flash.Memory.setFloat","flash/Memory.hx",195,0x29e6a1de)
		HX_STACK_ARG(addr,"addr")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(195)
...
{
		HX_STACK_FRAME("flash.Memory","setI16",0x6ac6d77b,"flash.Memory.setI16","flash/Memory.hx",203,0x29e6a1de)
		HX_STACK_ARG(addr,"addr")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(203)
...
{
		HX_STACK_FRAME("flash.Memory","setI32",0x6ac6d935,"flash.Memory.setI32","flash/Memory.hx",211,0x29e6a1de)
		HX_STACK_ARG(addr,"addr")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(211)
