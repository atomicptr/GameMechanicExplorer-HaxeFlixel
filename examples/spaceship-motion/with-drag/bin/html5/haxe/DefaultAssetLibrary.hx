...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		addExternal("assets/ship.png", "image", "assets/ship.png");
...
@:keep class __ASSET__assets_ship_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:bitmap("assets/ship.png") class __ASSET__assets_ship_png extends flash.display.BitmapData {}
