...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Christopher Kaster", "gme", "de.kasoki.gme.spaceshipmotion.basicmovement", "1.0.0");
		...
		flash.Lib.create (function () {
			...
			"Spaceship Motion - Basic Movement",
			null
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Spaceship Motion - Basic Movement", null, { width: 0, height: 0 });
