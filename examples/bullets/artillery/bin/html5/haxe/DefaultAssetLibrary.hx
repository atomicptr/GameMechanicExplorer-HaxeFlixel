...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		addExternal("assets/explosion.png", "image", "assets/explosion.png");
...
@:keep class __ASSET__assets_explosion_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:bitmap("assets/explosion.png") class __ASSET__assets_explosion_png extends flash.display.BitmapData {}
