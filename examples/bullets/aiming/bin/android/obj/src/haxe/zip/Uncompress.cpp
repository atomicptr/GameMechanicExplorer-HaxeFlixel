...
{
HX_STACK_FRAME("haxe.zip.Uncompress","new",0x34f307c2,"haxe.zip.Uncompress.new","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",28,0x2e2bbf2e)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.zip.Uncompress","setFlushMode",0xbecba0a3,"haxe.zip.Uncompress.setFlushMode","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",36,0x2e2bbf2e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(37)
