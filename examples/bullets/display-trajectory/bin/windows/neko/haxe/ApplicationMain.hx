...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Christopher Kaster", "gme_display_trajectory", "com.example.myapp", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "GME - Display Trajectory", null, { width: 800, height: 480 });
