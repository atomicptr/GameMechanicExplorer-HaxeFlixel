...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Christopher Kaster", "gme", "de.kasoki.gme.bullets.displaytrajectory", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Bullets - Display Trajectory", null, { width: 0, height: 0 });
