...
Void PlayState_obj::update( ){
{
		...
		struct _Function_1_1{
			inline static bool Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","states/PlayState.hx",74,0x36e487ae)
				{
					HX_STACK_LINE(74)
		...
		HX_STACK_LINE(74)
		if (((bool(_Function_1_1::Block()) && bool((this->elapsed >= this->SHOT_DELAY))))){
			HX_STACK_LINE(75)
			this->shootBullet();
			HX_STACK_LINE(78)
			this->elapsed = (int)0;
