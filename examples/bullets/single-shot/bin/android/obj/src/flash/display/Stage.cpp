...
HX_STACK_ARG(height,"height")
{
	...
	HX_STACK_LINE(102)
	this->renderRequest = ::flash::display::Stage_obj::lime_stage_request_render_dyn();
	HX_STACK_LINE(107)
...
{
		HX_STACK_FRAME("flash.display.Stage","dummyTrace",0x475ba937,"flash.display.Stage.dummyTrace","flash/display/Stage.hx",332,0x8d64160c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(332)
		::haxe::Log_obj::trace(HX_CSTRING(""),hx::SourceInfo(HX_CSTRING("Stage.hx"),332,HX_CSTRING("flash.display.Stage"),HX_CSTRING("dummyTrace")));
	}
return null();
}
...
{
		HX_STACK_FRAME("flash.display.Stage","__setActive",0x470cb0ae,"flash.display.Stage.__setActive","flash/display/Stage.hx",1026,0x8d64160c)
		HX_STACK_THIS(this)
		...
		if (((this->active != value))){
			...
			if ((value)){
				...
				HX_STACK_LINE(1048)
				if (((  (((focus->__get((int)0).StaticCast< ::flash::display::InteractiveObject >() != null()))) ? bool(focus->__get((int)0).StaticCast< ::flash::display::InteractiveObject >()->get_needsSoftKeyboard()) : bool(false) ))){

					HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_Function_4_1,Array< ::Dynamic >,focus,Array< ::Dynamic >,_g)
					Void run(){
						HX_STACK_FRAME("*","_Function_4_1",0x520333fa,"*._Function_4_1","flash/display/Stage.hx",1052,0x8d64160c)
						{
							HX_STACK_LINE(1052)
							if (((focus->__get((int)0).StaticCast< ::flash::display::InteractiveObject >() == _g->__get((int)0).StaticCast< ::flash::display::Stage >()->get_focus()))){
								HX_STACK_LINE(1054)
								_g->__get((int)0).StaticCast< ::flash::display::Stage >()->requestSoftKeyboard();
							}
						}
						return null();
					}
