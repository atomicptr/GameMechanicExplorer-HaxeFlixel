...
{
		HX_STACK_FRAME("flash.events.Event","stopImmediatePropagation",0x171efce8,"flash.events.Event.stopImmediatePropagation","flash/events/Event.hx",74,0x51d6b25b)
		HX_STACK_THIS(this)
		HX_STACK_LINE(74)
...
{
		HX_STACK_FRAME("flash.events.Event","stopPropagation",0x3c829ddf,"flash.events.Event.stopPropagation","flash/events/Event.hx",86,0x51d6b25b)
		HX_STACK_THIS(this)
		HX_STACK_LINE(86)
		if ((this->get_cancelable())){
			HX_STACK_LINE(88)
...
::String Event_obj::toString( ){
	HX_STACK_FRAME("flash.events.Event","toString",0xafa04817,"flash.events.Event.toString","flash/events/Event.hx",95,0x51d6b25b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(97)
	::String _g = this->get_type();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(97)
...
bool Event_obj::__getIsCancelled( ){
	HX_STACK_FRAME("flash.events.Event","__getIsCancelled",0xaf7a75dc,"flash.events.Event.__getIsCancelled","flash/events/Event.hx",104,0x51d6b25b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(104)
...
bool Event_obj::__getIsCancelledNow( ){
	HX_STACK_FRAME("flash.events.Event","__getIsCancelledNow",0xa0632c9a,"flash.events.Event.__getIsCancelledNow","flash/events/Event.hx",111,0x51d6b25b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(111)
...
{
		HX_STACK_FRAME("flash.events.Event","__setPhase",0x33646c84,"flash.events.Event.__setPhase","flash/events/Event.hx",118,0x51d6b25b)
		HX_STACK_THIS(this)
...
bool Event_obj::get_bubbles( ){
	HX_STACK_FRAME("flash.events.Event","get_bubbles",0x33ddd8f3,"flash.events.Event.get_bubbles","flash/events/Event.hx",130,0x51d6b25b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(130)
...
bool Event_obj::get_cancelable( ){
	HX_STACK_FRAME("flash.events.Event","get_cancelable",0x880c8208,"flash.events.Event.get_cancelable","flash/events/Event.hx",131,0x51d6b25b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(131)
...
Dynamic Event_obj::get_currentTarget( ){
	HX_STACK_FRAME("flash.events.Event","get_currentTarget",0x084142f6,"flash.events.Event.get_currentTarget","flash/events/Event.hx",132,0x51d6b25b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(132)
...
Dynamic Event_obj::set_currentTarget( Dynamic value){
	HX_STACK_FRAME("flash.events.Event","set_currentTarget",0x2baf1b02,"flash.events.Event.set_currentTarget","flash/events/Event.hx",133,0x51d6b25b)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(133)
...
::flash::events::EventPhase Event_obj::get_eventPhase( ){
	HX_STACK_FRAME("flash.events.Event","get_eventPhase",0x01d713b5,"flash.events.Event.get_eventPhase","flash/events/Event.hx",134,0x51d6b25b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(134)
...
Dynamic Event_obj::get_target( ){
	HX_STACK_FRAME("flash.events.Event","get_target",0x3782cb45,"flash.events.Event.get_target","flash/events/Event.hx",135,0x51d6b25b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(135)
...
Dynamic Event_obj::set_target( Dynamic value){
	HX_STACK_FRAME("flash.events.Event","set_target",0x3b0069b9,"flash.events.Event.set_target","flash/events/Event.hx",136,0x51d6b25b)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(136)
...
::String Event_obj::get_type( ){
	HX_STACK_FRAME("flash.events.Event","get_type",0x43f525ae,"flash.events.Event.get_type","flash/events/Event.hx",137,0x51d6b25b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(137)
	return this->__type;
}
