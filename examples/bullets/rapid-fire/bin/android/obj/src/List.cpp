...
bool List_obj::isEmpty( ){
	HX_STACK_FRAME("List","isEmpty",0xaa565653,"List.isEmpty","/usr/local/lib/haxe/std/List.hx",115,0xdb880ee3)
	HX_STACK_THIS(this)
	HX_STACK_LINE(115)
	return (this->h == null());
}
...
Dynamic List_obj::iterator( ){
	HX_STACK_FRAME("List","iterator",0x2d4cdfde,"List.iterator","/usr/local/lib/haxe/std/List.hx",179,0xdb880ee3)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static Dynamic Block( hx::ObjectPtr< ::List_obj > __this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/local/lib/haxe/std/List.hx",179,0xdb880ee3)
			{
				...
				Dynamic run(){
					HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","/usr/local/lib/haxe/std/List.hx",182,0xdb880ee3)
				...
				Dynamic run(){
					HX_STACK_FRAME("*","_Function_2_2",0x5201af79,"*._Function_2_2","/usr/local/lib/haxe/std/List.hx",185,0xdb880ee3)
					HX_STACK_THIS(__this.mPtr)
					{
						HX_STACK_LINE(186)
