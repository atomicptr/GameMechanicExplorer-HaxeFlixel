...
states.PlayState.prototype = $extend(flixel.FlxState.prototype,{
	...
	,update: function() {
		...
		this.gun.set_angle(flixel.util.FlxAngle.angleBetweenMouse(this.gun,true));
	...
	,shootBullet: function() {
		...
		bullet.set_angle(flixel.util.FlxAngle.angleBetweenMouse(bullet,true));
		bullet.velocity.set_x(Math.cos(bullet.angle * (Math.PI / 180)) * this.BULLET_SPEED);
		bullet.velocity.set_y(Math.sin(bullet.angle * (Math.PI / 180)) * this.BULLET_SPEED);
	}
