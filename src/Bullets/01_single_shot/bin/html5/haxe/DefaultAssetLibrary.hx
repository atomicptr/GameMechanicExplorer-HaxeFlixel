...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		addExternal("assets/bullet.png", "image", "assets/bullet.png");
...
@:keep class __ASSET__assets_bullet_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:sound("/usr/local/haxe/lib/flixel/3,3,2/assets/sounds/beep.mp3") class __ASSET__assets_sounds_beep_mp3 extends flash.media.Sound {}
@:sound("/usr/local/haxe/lib/flixel/3,3,2/assets/sounds/flixel.mp3") class __ASSET__assets_sounds_flixel_mp3 extends flash.media.Sound {}
@:sound("/usr/local/haxe/lib/flixel/3,3,2/assets/sounds/beep.ogg") class __ASSET__assets_sounds_beep_ogg extends flash.media.Sound {}
@:sound("/usr/local/haxe/lib/flixel/3,3,2/assets/sounds/flixel.ogg") class __ASSET__assets_sounds_flixel_ogg extends flash.media.Sound {}
@:bitmap("assets/bullet.png") class __ASSET__assets_bullet_png extends flash.display.BitmapData {}
