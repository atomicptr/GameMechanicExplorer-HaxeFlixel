...
class PlayState extends FlxState {
	...
	private function leftPressed(?useJustPressed:Bool = false):Bool {
		var leftKeyPressed = useJustPressed ? FlxG.keys.justPressed.LEFT : FlxG.keys.pressed.LEFT;
	...
	private function rightPressed(?useJustPressed:Bool = false):Bool {
		var rightKeyPressed = useJustPressed ? FlxG.keys.justPressed.RIGHT : FlxG.keys.pressed.RIGHT;
	...
	private function upPressed(?useJustPressed:Bool = false):Bool {
		var upKeyPressed = useJustPressed ? FlxG.keys.justPressed.UP : FlxG.keys.pressed.UP;
