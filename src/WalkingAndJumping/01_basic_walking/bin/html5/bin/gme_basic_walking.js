...
states.PlayState.prototype = $extend(flixel.FlxState.prototype,{
	...
	,update: function() {
		...
		if(flixel.FlxG.keys.checkKeyStatus(["LEFT"],1)) this.player.velocity.set_x(-this.MAX_SPEED); else if(flixel.FlxG.keys.checkKeyStatus(["RIGHT"],1)) this.player.velocity.set_x(this.MAX_SPEED); else this.player.velocity.set_x(0);
