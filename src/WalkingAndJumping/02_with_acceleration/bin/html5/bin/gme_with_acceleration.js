...
states.PlayState.prototype = $extend(flixel.FlxState.prototype,{
	...
	,update: function() {
		...
		if(flixel.FlxG.keys.checkKeyStatus(["LEFT"],1)) this.player.acceleration.set_x(-this.ACCELERATION); else if(flixel.FlxG.keys.checkKeyStatus(["RIGHT"],1)) this.player.acceleration.set_x(this.ACCELERATION); else {
